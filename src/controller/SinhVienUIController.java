...
public class SinhVienUIController implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (actionCommand.equals("Tìm kiếm điểm")) {
            String Condition = sinhVienUI.getjComboBox_TimKiemDiem().getSelectedItem() + " LIKE '%" + sinhVienUI.getjTextField_TuKhoaDiem().getText() + "%'" + "AND `MSSV` LIKE '" + sinhVienUI.getMSSV() + "'";
